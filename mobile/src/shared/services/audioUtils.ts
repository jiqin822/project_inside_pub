...
export async function base64WavToPcmMedia(
  base64Wav: string,
  ...
  if (decoded.sampleRate !== targetSampleRate) {
    ...
    source.start(0);
    bufferToUse = await offlineCtx.startRendering();
  }

  const channelData = bufferToUse.getChannelData(0);
