...
export const AuthScreen: React.FC<Props> = ({ 
  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans text-slate-900 safe-area" style={{ height: '100vh', width: '100vw' }}>
       ...
       {/* Footer: branding + API URL so user can confirm correct server (e.g. production vs localhost) */}
       <div className="absolute bottom-6 flex flex-col items-center gap-1 opacity-70">
           ...
           <p className="text-[9px] font-mono text-slate-400 break-all max-w-[90vw] text-center" title="API base URL">
